...
# Copied from vocab.py of BERT4rec
...
class FreqVocab(object):
    ...
    # While BERT uses Wordpiece Tokenizer for 3 layers of input representation,
    # BERT4rec use toeknization based on sorting preprocessed inputs by frequency
